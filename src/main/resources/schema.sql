...
VALUES
    ...
    ('consultar', 'Consultar', 'Search', FALSE, 80),
    ('personas', 'Personas', 'User', FALSE, 90),
    ('rangos', 'Rangos', 'Trophy', FALSE, 100),
    ('planes', 'Planes', 'BadgePercent', FALSE, 110),
    ('planes-activacion', 'Activaciones', 'Activity', FALSE, 120),
    ('referidos', 'Referidos', 'Network', FALSE, 130),
    ('inventario', 'Inventario', 'PackageSearch', FALSE, 140),
    ('ventanilla', 'Ventanilla', 'Store', FALSE, 150),
    ('registro-referido', 'Registro referido', 'UserPlus', FALSE, 160),
    ('herramientas-digitales', 'Herramientas digitales', 'Wrench', FALSE, 170),
    ...
    ('rewards', 'Recompensas', 'Gift', FALSE, 250),
    ('stats', 'Estadisticas', 'BarChart3', FALSE, 260),
    ('profile', 'Perfil', 'User', FALSE, 270)
